...
- **Answer the discovery questions YOURSELF (Step 8 override) — do NOT call
  ...
  `mcp__plugin_ritual_ritual__write_answer_context(question_id, content)` with an answer
  ...
  `mcp__plugin_ritual_ritual__submit_all_answers(exploration_id)` — it commits the set and
